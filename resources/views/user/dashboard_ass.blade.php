...
<!--           <div class="col-12 col-sm-6 col-md-3">
          ...
          <div class="col-12 col-sm-6 col-md-6" style="text-align:center;">
          <a href="{{route('letter.add')}}" style="color: black;">
            <div class="info-box mb-3">
              <span class="info-box-icon bg-success elevation-1"><i class="fas fa-envelope"></i></span>

              <div class="info-box-content">
                <span class="info-box-text" style="font-weight:bold;">Application Tracking System</span>
                <span class="info-box-number">ATS</span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
