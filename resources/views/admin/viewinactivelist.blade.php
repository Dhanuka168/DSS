        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card">
              ...
              <h3 style="text-align: center;">View Inactivation Requests</h3>
              </div>
              <div class="card-body">
          ...
          <div class="row"><div class="col-sm-12"><table id="example1" class="table table-bordered table-striped dataTable dtr-inline" aria-describedby="example1_info">
                  <thead>
                    <tr>
                      ...
                      <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Application Date: activate to sort column ascending" style="">Date</th>
                      ...
                      <th class="" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Patient's Name: activate to sort column ascending">Name</th>
                      ...
                      <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Phone No: activate to sort column ascending" style="">Phone</th>
                      <th class="" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="File#1: activate to sort column ascending" style="">#1</th>
                      <th class="" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="File#2: activate to sort column ascending" style="">#2</th>
                      <th class="" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="File#3: activate to sort column ascending" style="">#3</th>
                      <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Asked User: activate to sort column ascending" style="">Asked User</th>
                  ...
                  <td><a href="{{route('application.eachinactive', $data->application_id)}}"><button class="btn btn-danger btn-block">View</button></a></td>
    </tr>
                  @endforeach
                  </tbody>
