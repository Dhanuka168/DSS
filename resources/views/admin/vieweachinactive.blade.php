          ...
          <div class="col-md-10">
            ...
            <div class="card card-warning">
              <div class="card-header">
                <div style="text-align:center; font-size:18px; font-weight:bold;">Asked for Inactivation</div>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              ...
              <form class="form-horizontal" method="post" id="frmEachApp" action="{{route('application.notinactive')}}">
                ...
                <div class="card-body">
                 ...
                 <div class="row">
                    ...
                    <div class="col-md-2"><a href="#"><button type="button" id="btninactive" class="btn btn-danger btn-block">Inactive</button></a></div>
                    <div class="col-md-2"><button type="submit" class="btn btn-warning btn-block">Not Inactive</button></div>
                    <div class="col-md-2"><a href="{{route('application.inactivelist')}}"><button type="button" class="btn btn-primary btn-block">Cancel</button></a></div>
