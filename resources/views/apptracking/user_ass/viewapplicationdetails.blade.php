...
@extends('layouts.frontenduser_ass')
@section('content')
          ...
          <div class="row"><div class="col-sm-12"><table id="example1" class="table table-bordered table-striped dataTable dtr-inline" aria-describedby="example1_info">
                  <thead>
                    <tr>
                      ...
                      <th class="" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Applicant's Name: activate to sort column ascending">Applicant's Name</th>
                      <th class="" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Applicant's NIC: activate to sort column ascending" style="">Applicant's NIC</th>
                      ...
                      <th class="" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Patient's NIC: activate to sort column ascending" style="">Patient's NIC</th>
                      ...
                      <th class="" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="city: activate to sort column ascending" style="">City</th>
