        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card">
              ...
              <h3 style="text-align: center;">View Inactivated Applications</h3>
              </div>
              <div class="card-body">
          ...
          <div class="row"><div class="col-sm-12"><table id="example1" class="table table-bordered table-striped dataTable dtr-inline" aria-describedby="example1_info">
                  <thead>
                    <tr>
                      ...
                      <th class="" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="File#1: activate to sort column ascending" style="">File#1</th>
                  ...
                  <td><a href="{{route('application.eachinactivated', $data->application_id)}}"><button class="btn btn-danger btn-block">View</button></a></td>
    </tr>
                  @endforeach
                  </tbody>
